...
Este proyecto fue generado usando [Angular CLI](https://github.com/angular/angular-cli) versión 19.2.18.
...
Una vez que el servidor esté en funcionamiento, abre tu navegador y ve a `http://localhost:4200/`. La aplicación se recargará automáticamente cada vez que modifiques cualquiera de los archivos de código.
...
Para ejecutar pruebas unitarias con el ejecutor [Karma](https://karma-runner.github.io), usa el siguiente comando:
...
Angular CLI no incluye un marco de pruebas end-to-end de forma predeterminada. Puedes elegir uno que se ajuste a tus necesidades.
